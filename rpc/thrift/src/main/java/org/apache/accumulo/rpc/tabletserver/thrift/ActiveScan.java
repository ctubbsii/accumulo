...
@SuppressWarnings("all") public class ActiveScan implements org.apache.thrift.TBase<ActiveScan, ActiveScan._Fields>, java.io.Serializable, Cloneable {
  ...
  public ActiveScan setExtent(org.apache.accumulo.rpc.data.thrift.TKeyExtent extent) {
    this.extent = extent;
    return this;
  }
  ...
  public ActiveScan setColumns(List<org.apache.accumulo.rpc.data.thrift.TColumn> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public ActiveScan setSsiList(List<org.apache.accumulo.rpc.data.thrift.IterInfo> ssiList) {
    this.ssiList = ssiList;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<org.apache.accumulo.rpc.data.thrift.TColumn>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  org.apache.accumulo.rpc.data.thrift.TColumn _elem10; // required
                  _elem10 = new org.apache.accumulo.rpc.data.thrift.TColumn();
                  _elem10.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ssiList = new ArrayList<org.apache.accumulo.rpc.data.thrift.IterInfo>(_list11.size);
                for (int _i12 = 0; _i12 < _list11.size; ++_i12)
                {
                  org.apache.accumulo.rpc.data.thrift.IterInfo _elem13; // required
                  _elem13 = new org.apache.accumulo.rpc.data.thrift.IterInfo();
                  _elem13.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ActiveScan struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TColumn _iter22 : struct.columns)
          {
            _iter22.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.ssiList != null) {
        oprot.writeFieldBegin(SSI_LIST_FIELD_DESC);
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.IterInfo _iter23 : struct.ssiList)
          {
            _iter23.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TColumn _iter26 : struct.columns)
          {
            _iter26.write(oprot);
          }
        }
      ...
      if (struct.isSetSsiList()) {
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.IterInfo _iter27 : struct.ssiList)
          {
            _iter27.write(oprot);
          }
        }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.columns = new ArrayList<org.apache.accumulo.rpc.data.thrift.TColumn>(_list30.size);
          for (int _i31 = 0; _i31 < _list30.size; ++_i31)
          {
            org.apache.accumulo.rpc.data.thrift.TColumn _elem32; // required
            _elem32 = new org.apache.accumulo.rpc.data.thrift.TColumn();
            _elem32.read(iprot);
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.ssiList = new ArrayList<org.apache.accumulo.rpc.data.thrift.IterInfo>(_list33.size);
          for (int _i34 = 0; _i34 < _list33.size; ++_i34)
          {
            org.apache.accumulo.rpc.data.thrift.IterInfo _elem35; // required
            _elem35 = new org.apache.accumulo.rpc.data.thrift.IterInfo();
            _elem35.read(iprot);
