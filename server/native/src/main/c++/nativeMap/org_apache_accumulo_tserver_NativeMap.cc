...
JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_createNM(
    JNIEnv *env, jclass cls) {
  return (jlong)(new NativeMap(1 << 17, 1 << 11));
}

JNIEXPORT jint JNICALL Java_org_apache_accumulo_tserver_NativeMap_sizeNM(
    JNIEnv *env, jclass cls, jlong nm) {
  return ((NativeMap*) nm)->count;
}

JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_memoryUsedNM(
    JNIEnv *env, jclass cls, jlong nm) {
...
JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_startUpdate(
    JNIEnv *env, jclass cls, jlong nm, jbyteArray r) {
...
JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_deleteNM(
    JNIEnv *env, jclass cls, jlong nm) {
  NativeMap *nativeMap = (NativeMap*) nm;
  delete (nativeMap);
  return 0;
...
JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_createNMI__J_3I(
    JNIEnv *env, jclass cls, jlong nm, jintArray lens) {
  NativeMap *nativeMap = (NativeMap*) nm;
  int32_t ia[7];
...
JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_createNMI__J_3B_3B_3B_3BJZ_3I(
    JNIEnv *env, jclass cls, jlong nm, jbyteArray r, jbyteArray cf,
    jbyteArray cq, jbyteArray cv, jlong ts, jboolean del, jintArray lens) {
...
JNIEXPORT jboolean JNICALL Java_org_apache_accumulo_tserver_NativeMap_nmiNext(
    JNIEnv *env, jclass cls, jlong ip, jintArray lens) {
...
JNIEXPORT jlong JNICALL Java_org_apache_accumulo_tserver_NativeMap_nmiGetTS(
    JNIEnv *env, jclass cls, jlong ip) {
  Iterator &iter = *((Iterator*) ip);
