...
@SuppressWarnings("all") public class TabletMutations implements org.apache.thrift.TBase<TabletMutations, TabletMutations._Fields>, java.io.Serializable, Cloneable {
  ...
  public TabletMutations setMutations(List<org.apache.accumulo.rpc.data.thrift.TMutation> mutations) {
    this.mutations = mutations;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mutations = new ArrayList<org.apache.accumulo.rpc.data.thrift.TMutation>(_list62.size);
                for (int _i63 = 0; _i63 < _list62.size; ++_i63)
                {
                  org.apache.accumulo.rpc.data.thrift.TMutation _elem64; // required
                  _elem64 = new org.apache.accumulo.rpc.data.thrift.TMutation();
                  _elem64.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TabletMutations struct) throws org.apache.thrift.TException {
      ...
      if (struct.mutations != null) {
        oprot.writeFieldBegin(MUTATIONS_FIELD_DESC);
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TMutation _iter65 : struct.mutations)
          {
            _iter65.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMutations()) {
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TMutation _iter66 : struct.mutations)
          {
            _iter66.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.mutations = new ArrayList<org.apache.accumulo.rpc.data.thrift.TMutation>(_list67.size);
          for (int _i68 = 0; _i68 < _list67.size; ++_i68)
          {
            org.apache.accumulo.rpc.data.thrift.TMutation _elem69; // required
            _elem69 = new org.apache.accumulo.rpc.data.thrift.TMutation();
            _elem69.read(iprot);
