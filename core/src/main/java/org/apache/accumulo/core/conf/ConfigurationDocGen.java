    ...
    doc.printf("""
        ...
        **Available since:** %s<br>
        ...
        depr && prefix.isReplaced() ? """
            *Replaced by:* <a href="#%sprefix">%s</a><br>"""
            .formatted(prefix.replacedBy().getKey().replace(".", "_"), prefix.replacedBy()) : "",
    ...
    doc.printf("""
        ...
        **type:** %s, **zk mutable:** %s, **default value:** %s
        ...
        depr && prop.isReplaced() ? """
            *Replaced by:* <a href="#%s">%s</a><br>"""
            .formatted(prop.replacedBy().getKey().replace(".", "_"), prop.replacedBy()) : "",
