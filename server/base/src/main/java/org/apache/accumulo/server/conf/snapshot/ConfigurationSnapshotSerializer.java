...
public class ConfigurationSnapshotSerializer {
  ...
  public ConfigurationSnapshotSerializer(final String path, final ZooCache zooCache) {
    this.path = path;
  ...
  public String toString() {
    // ConfigurationSnapshot snapshot = snapshotConf.get();
  ...
  public static void main(String[] args) {
    ConfigurationSnapshotSerializer confBlob = new ConfigurationSnapshotSerializer("/some/path", null);
