...
do
   mkdir -p src/main/java/org/apache/accumulo/rpc/$d/thrift >& /dev/null
   for f in target/gen-java/org/apache/accumulo/rpc/$d/thrift/* 
   do
      DEST="src/main/java/org/apache/accumulo/rpc/$d/thrift/`basename $f`"
