...
@SuppressWarnings("all") public class ConstraintViolationException extends Exception implements org.apache.thrift.TBase<ConstraintViolationException, ConstraintViolationException._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary> violationSummaries; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.VIOLATION_SUMMARIES, new org.apache.thrift.meta_data.FieldMetaData("violationSummaries", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary.class))));
  ...
  public ConstraintViolationException(
    List<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary> violationSummaries)
  {
    this();
  ...
  public ConstraintViolationException(ConstraintViolationException other) {
    if (other.isSetViolationSummaries()) {
      List<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary> __this__violationSummaries = new ArrayList<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary>();
      for (org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary other_element : other.violationSummaries) {
        __this__violationSummaries.add(new org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary(other_element));
      }
  ...
  public java.util.Iterator<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary> getViolationSummariesIterator() {
    return (this.violationSummaries == null) ? null : this.violationSummaries.iterator();
  }

  public void addToViolationSummaries(org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary elem) {
    if (this.violationSummaries == null) {
      this.violationSummaries = new ArrayList<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary>();
    }
    this.violationSummaries.add(elem);
  }

  public List<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary> getViolationSummaries() {
    return this.violationSummaries;
  }

  public ConstraintViolationException setViolationSummaries(List<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary> violationSummaries) {
    this.violationSummaries = violationSummaries;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VIOLATION_SUMMARIES:
      if (value == null) {
        ...
        setViolationSummaries((List<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.violationSummaries = new ArrayList<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary _elem2; // required
                  _elem2 = new org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ConstraintViolationException struct) throws org.apache.thrift.TException {
      ...
      if (struct.violationSummaries != null) {
        oprot.writeFieldBegin(VIOLATION_SUMMARIES_FIELD_DESC);
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary _iter3 : struct.violationSummaries)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetViolationSummaries()) {
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary _iter4 : struct.violationSummaries)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.violationSummaries = new ArrayList<org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary _elem7; // required
            _elem7 = new org.apache.accumulo.rpc.data.thrift.TConstraintViolationSummary();
            _elem7.read(iprot);
