...
@SuppressWarnings("all") public class TabletSplit implements org.apache.thrift.TBase<TabletSplit, TabletSplit._Fields>, java.io.Serializable, Cloneable {
  ...
  public org.apache.accumulo.rpc.data.thrift.TKeyExtent oldTablet; // required
  public List<org.apache.accumulo.rpc.data.thrift.TKeyExtent> newTablets; // required
  ...
  public TabletSplit(
    org.apache.accumulo.rpc.data.thrift.TKeyExtent oldTablet,
    List<org.apache.accumulo.rpc.data.thrift.TKeyExtent> newTablets)
  {
    this();
  ...
  public TabletSplit(TabletSplit other) {
    if (other.isSetOldTablet()) {
      this.oldTablet = new org.apache.accumulo.rpc.data.thrift.TKeyExtent(other.oldTablet);
    }
    if (other.isSetNewTablets()) {
      List<org.apache.accumulo.rpc.data.thrift.TKeyExtent> __this__newTablets = new ArrayList<org.apache.accumulo.rpc.data.thrift.TKeyExtent>();
      for (org.apache.accumulo.rpc.data.thrift.TKeyExtent other_element : other.newTablets) {
        __this__newTablets.add(new org.apache.accumulo.rpc.data.thrift.TKeyExtent(other_element));
      }
  ...
  public org.apache.accumulo.rpc.data.thrift.TKeyExtent getOldTablet() {
    return this.oldTablet;
  }

  public TabletSplit setOldTablet(org.apache.accumulo.rpc.data.thrift.TKeyExtent oldTablet) {
    this.oldTablet = oldTablet;
    return this;
  }
  ...
  public java.util.Iterator<org.apache.accumulo.rpc.data.thrift.TKeyExtent> getNewTabletsIterator() {
    return (this.newTablets == null) ? null : this.newTablets.iterator();
  }

  public void addToNewTablets(org.apache.accumulo.rpc.data.thrift.TKeyExtent elem) {
    if (this.newTablets == null) {
      this.newTablets = new ArrayList<org.apache.accumulo.rpc.data.thrift.TKeyExtent>();
    }
    this.newTablets.add(elem);
  }

  public List<org.apache.accumulo.rpc.data.thrift.TKeyExtent> getNewTablets() {
    return this.newTablets;
  }

  public TabletSplit setNewTablets(List<org.apache.accumulo.rpc.data.thrift.TKeyExtent> newTablets) {
    this.newTablets = newTablets;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OLD_TABLET:
      if (value == null) {
        ...
        setOldTablet((org.apache.accumulo.rpc.data.thrift.TKeyExtent)value);
      }
      break;
    ...
    case NEW_TABLETS:
      if (value == null) {
        ...
        setNewTablets((List<org.apache.accumulo.rpc.data.thrift.TKeyExtent>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // OLD_TABLET
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.oldTablet = new org.apache.accumulo.rpc.data.thrift.TKeyExtent();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.newTablets = new ArrayList<org.apache.accumulo.rpc.data.thrift.TKeyExtent>(_list62.size);
                for (int _i63 = 0; _i63 < _list62.size; ++_i63)
                {
                  org.apache.accumulo.rpc.data.thrift.TKeyExtent _elem64; // required
                  _elem64 = new org.apache.accumulo.rpc.data.thrift.TKeyExtent();
                  _elem64.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TabletSplit struct) throws org.apache.thrift.TException {
      ...
      if (struct.newTablets != null) {
        oprot.writeFieldBegin(NEW_TABLETS_FIELD_DESC);
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TKeyExtent _iter65 : struct.newTablets)
          {
            _iter65.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetNewTablets()) {
        {
          ...
          for (org.apache.accumulo.rpc.data.thrift.TKeyExtent _iter66 : struct.newTablets)
          {
            _iter66.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.newTablets = new ArrayList<org.apache.accumulo.rpc.data.thrift.TKeyExtent>(_list67.size);
          for (int _i68 = 0; _i68 < _list67.size; ++_i68)
          {
            org.apache.accumulo.rpc.data.thrift.TKeyExtent _elem69; // required
            _elem69 = new org.apache.accumulo.rpc.data.thrift.TKeyExtent();
            _elem69.read(iprot);
